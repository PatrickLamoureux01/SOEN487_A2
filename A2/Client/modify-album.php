            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Modify Album</h1>
                    </div>

                    <form>
                        <div class="form-group">
                            <label for="isrc">ISRC</label>
                            <input type="text" class="form-control" id="isrc">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="lname">Artist Last Name</label>
                            <input type="text" class="form-control" id="lname">
                        </div>
                        <div class="form-group">
                            <label for="nickname">Artist Nickname</label>
                        ...
                        <button type="button" id="submitBtn" class="btn btn-primary">Modify Album</button>
                    </form>
    ...
    <script>
        $(document).ready(function() {
            $('#submitBtn').click(function() {
                ...
                var bio = $('#bio').val();
                var url = 'http://localhost:8080/A2/albums/' + isrc + '/' + title + '/' + description + '/' + year + '/' + fname + '/' + lname + '/' + nickname + '/' + bio;
