...
<head>
    ...
    <title>Delete Album Cover</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Delete Album Cover</h1>
                    </div>

                    <div class="search">
                        ISRC <input type="text" name="searchBtn" id="searchBtn"></input>
                        <button class="btn btn-primary" type="button" id="submitBtn">Delete Album Cover</button>
                    </div>
