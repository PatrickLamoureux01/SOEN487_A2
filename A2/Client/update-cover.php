...
<head>
    ...
    <title>Update Album Cover</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update Album Cover</h1>
                    </div>

                    <form id="search">
                        <label for="searchBtn">ISRC</label>
                        <input type="text" name="searchBtn" id="searchBtn"></input>
                        <br>
                        <label for="image">Cover Photo</label>
                        <input type="file" id="image"></input>
                        <br>
                        <br>
                        <button class="btn btn-primary" type="button" id="submitBtn">Add Cover Photo</button>
                    </form>
                </div>
                <!-- /.container-fluid -->
    ...
    <script>
        $(document).ready(function() {
            $('#submitBtn').click(function() {
                ...
                var isrc = $('#searchBtn').val();
                var url = 'http://localhost:8080/A2/albums/cover/' + isrc;
                var files = $('#image')[0].files;
                var formData = new FormData();
                formData.append('g', files[0]);
