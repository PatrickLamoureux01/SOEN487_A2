...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">View Album</h1>
                    </div>

                    <div class="search">
                        ISRC <input type="text" name="searchBtn" id="searchBtn"></input>
                        <button class="btn btn-primary" type="button" onclick="search()">Submit</button>
                    </div>
    ...
    <script>
        function search() {
            ...
            var url = 'http://localhost:8080/A2/albums/' + $('#searchBtn').val();
            var imgurlget = 'http://localhost:8080/A2/albums/cover/' + $('#searchBtn').val();
            ...
            if (msg.includes("Error")) {
                ...
                $.get(url, function(data) {
                    console.log(data);
                    document.getElementById("res").innerHTML += "ISRC: " + data['isrc'] +
                    "<br>" +
                    "Title: " + data['title'] +
                    "<br>" +
                    ...
                    "<br>" +
                    "Artist First Name: " + data['artist']['fName'] +
                    "<br>" +
                    "Artist Last Name: " + data['artist']['lName'] +
                    "<br>" +
                ...
                if (imgurl.includes("Error")) {
                    document.getElementById("res").innerHTML += "Cover Photo: N/A";
                } else {
                    document.getElementById("res").innerHTML += "Cover Photo: <img src='file:///D:/User/OneDrive - Concordia University - Canada/School/Concordia/Semester_7/SOEN487/Assignments/A2/A2/images/RReY06qNF7.jpg'>";
                }
            }
