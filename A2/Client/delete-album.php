            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Delete Album</h1>
                    </div>

                    <div class="search">
                        ISRC <input type="text" name="searchBtn" id="searchBtn"></input>
                        <button class="btn btn-primary" type="button" id="submitBtn">Delete Album</button>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#submitBtn').click(function() {
                ...
                var url = 'http://localhost:8080/A2/albums/' + isrc;
